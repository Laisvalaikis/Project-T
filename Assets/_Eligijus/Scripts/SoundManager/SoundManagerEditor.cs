...
public class SoundManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (!soundManager.createSoundType && !soundManager.createSound && !soundManager.editSound && !soundManager.editSoundType && !soundManager.removeSoundType && !soundManager.removeSound)
        {
            ...
            soundManager.sounds = soundManager.SoundsData.GetSound(soundManager.songSelection, soundManager.songSelection);
        ...
        if (soundManager.createSoundType)
        {
            ...
            soundManager.soundTypeName = EditorGUILayout.TextArea( soundManager.soundTypeName, GUILayout.MaxHeight(17) );
            soundManager.selectedSoundIndex = EditorGUILayout.Popup("Select sound to add: ", soundManager.selectedSoundIndex, allSongNames);
            ...
            if (soundManager.selectedSoundIndexArray != null)
            {
                ...
                {
                    soundManager.selectedSoundIndexArray[i] = EditorGUILayout.Popup("Selected Sound: ", soundManager.selectedSoundIndex, allSongNames);
                }
            }
            ...
            if (GUILayout.Button("Add Sound To Effects"))
            {
                ...
                Sound tempSoundToAdd = soundManager.SoundsData.GetSoundFromAllSounds(soundManager.selectedSoundIndex);
                if (tempSoundToAdd != null && soundManager.soundsToAdd != null)
                {
                    soundManager.soundsToAdd.Add(tempSoundToAdd);
                    soundManager.selectedSoundIndexArray.Add(soundManager.SoundsData.GetSoundIndexFromAll(tempSoundToAdd));
                }
            }
        ...
        if (soundManager.createSound)
        {
            ...
            {
                string fullPath = EditorUtility.SaveFilePanelInProject("Create New Sound", "NewSound", "asset", "Save file");
        ...
        {
            string[] allSongNames = soundManager.SoundsData.GetAllSoundNames();
            soundManager.selectedSoundIndex = EditorGUILayout.Popup("Select Pose Data Edit: ", soundManager.selectedSoundIndex, allSongNames);

            if (soundManager.soundToEdit != soundManager.SoundsData.GetSoundFromAllSounds(soundManager.selectedSoundIndex))
            {
                soundManager.soundToEdit = soundManager.SoundsData.GetSoundFromAllSounds(soundManager.selectedSoundIndex);
        ...
        if (soundManager.editSoundType && soundManager.SoundsData.EffectTypeCount() > 0)
        {
            ...
            string[] allSongNames = soundManager.SoundsData.GetAllSoundNames();
            soundManager.soundTypeName = EditorGUILayout.TextArea( soundManager.soundTypeName, GUILayout.MaxHeight(17) );
            soundManager.effectSelection = EditorGUILayout.Popup("Select Pose Data Edit: ", soundManager.effectSelection, allEffectNames);
            ...
            if (soundManager.selectedSoundIndexArray != null)
            {
                for (int i = 0; i < soundManager.selectedSoundIndexArray.Count; i++)
                {
                    soundManager.selectedSoundIndexArray[i] = EditorGUILayout.Popup("Select Pose Data Edit: ", soundManager.selectedSoundIndexArray[i], allSongNames);
                }
            ...
            GUILayout.BeginHorizontal();
            EditorGUI.BeginDisabledGroup(soundManager.selectedSoundIndexArray.Count == 0 || soundManager.soundType.name == "");
            if (GUILayout.Button("Save"))
            {
                soundManager.soundType.name = soundManager.soundTypeName;
                soundManager.soundType.soundList = new List<Sound>();
                ...
                for (int i = 0; i < soundManager.selectedSoundIndexArray.Count; i++)
                {
                    if (!soundManager.soundType.soundList.Contains(soundManager.SoundsData.GetSoundFromAllSounds(soundManager.selectedSoundIndexArray[i])))
                    {
                        
                        soundManager.soundType.soundList.Add(soundManager.SoundsData.GetSoundFromAllSounds(soundManager.selectedSoundIndexArray[i]));
        ...
        if (soundManager.removeSound)
        {
            ...
            string[] allSongNames = soundManager.SoundsData.GetAllSoundNames();
            soundManager.songSelection = EditorGUILayout.Popup("Select Pose Data Edit: ", soundManager.effectSelection, allSongNames);
            GUILayout.BeginHorizontal();
